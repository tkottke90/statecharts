...
function createTestState(data: Record<string, unknown> = {}): InternalState {
  ...
  describe('IfNode', () => {
    describe('Schema Validation', () => {
      it('should create IfNode with valid condition', () => {
        const result = IfNode.createFromJSON({
          if: { cond: 'x == 1', content: '', children: [] },
        });
    ...
    describe('Basic Execution', () => {
      ...
      it('should handle condition evaluation errors', async () => {
        ...
        expect(result._pendingInternalEvents![0].data.error).toContain(
    ...
    describe('If-Else Execution', () => {
      it('should execute if branch when condition is true', async () => {
        ...
        const elseAssign = new AssignNode({
          assign: {
            location: 'data.result',
            expr: '"else branch"',
            content: '',
        ...
        const elseNode = new ElseNode({
          else: { content: '', children: [elseAssign] },
        });
        const ifNode = new IfNode({
          if: {
            cond: 'data.x == 1',
            content: '',
            children: [ifAssign, elseNode],
          },
        });
    ...
    describe('If-ElseIf-Else Chains', () => {
      it('should execute first matching elseif condition', async () => {
        ...
        const elseIf1Assign = new AssignNode({
          assign: {
            location: 'data.result',
            expr: '"elseif1 branch"',
            content: '',
        ...
        const elseIf2Assign = new AssignNode({
          assign: {
            location: 'data.result',
            expr: '"elseif2 branch"',
            content: '',
        ...
        const elseIf1 = new ElseIfNode({
          elseif: {
            cond: 'data.x == 1',
            content: '',
            children: [elseIf1Assign],
          },
        });
        const elseIf2 = new ElseIfNode({
          elseif: {
            cond: 'data.x == 2',
            content: '',
            children: [elseIf2Assign],
          },
        });
        const elseNode = new ElseNode({
          else: { content: '', children: [elseAssign] },
        ...
        const ifNode = new IfNode({
          if: {
            cond: 'data.x == 0',
            content: '',
            children: [ifAssign, elseIf1, elseIf2, elseNode],
          },
        });
      ...
      it('should execute else when no conditions match', async () => {
        ...
        const ifNode = new IfNode({
          if: {
            cond: 'data.x == 0',
            content: '',
            children: [ifAssign, elseIf1, elseNode],
          },
        });
  ...
  describe('ElseIfNode', () => {
    describe('Schema Validation', () => {
      it('should create ElseIfNode with valid condition', () => {
        const result = ElseIfNode.createFromJSON({
          elseif: { cond: 'y == 2', content: '', children: [] },
        });
        expect(result.success).toBe(true);
        if (result.success) {
    ...
    describe('Standalone Execution', () => {
      it('should execute children when condition is true', async () => {
        const assignNode = new AssignNode({
          assign: {
            location: 'data.result',
            expr: '"elseif executed"',
            content: '',
            children: [],
          },
        });
        const elseIfNode = new ElseIfNode({
          elseif: { cond: 'data.y == 2', content: '', children: [assignNode] },
        });
      ...
      it('should not execute children when condition is false', async () => {
        ...
        const elseIfNode = new ElseIfNode({
          elseif: { cond: 'data.y == 3', content: '', children: [assignNode] },
        });
  ...
  describe('ElseNode', () => {
    ...
    describe('Execution', () => {
      it('should always execute children', async () => {
        ...
        const elseNode = new ElseNode({
          else: { content: '', children: [assignNode] },
        });
      ...
      it('should always return true for condition evaluation', async () => {
        ...
        const [conditionResult] =
          await elseNode.evaluateCondition(initialState);
  ...
  describe('Integration Tests', () => {
    describe('Nested Conditionals', () => {
      it('should handle nested if statements', async () => {
        const innerAssign = new AssignNode({
          assign: {
            location: 'data.result',
            expr: '"nested executed"',
            content: '',
            children: [],
          },
        });
        const innerIf = new IfNode({
          if: { cond: 'data.y == 2', content: '', children: [innerAssign] },
        });
        const outerIf = new IfNode({
          if: { cond: 'data.x == 1', content: '', children: [innerIf] },
        });
      ...
      it('should handle nested if-else in elseif branch', async () => {
        ...
        const nestedAssign = new AssignNode({
          assign: {
            location: 'data.result',
            expr: '"nested in elseif"',
            content: '',
            children: [],
          },
        });
        const nestedElseAssign = new AssignNode({
          assign: {
            location: 'data.result',
            expr: '"nested else"',
            content: '',
        ...
        const nestedElse = new ElseNode({
          else: { content: '', children: [nestedElseAssign] },
        });
        const nestedIf = new IfNode({
          if: {
            cond: 'data.y == 2',
            content: '',
            children: [nestedAssign, nestedElse],
          },
        });

        const elseIf = new ElseIfNode({
          elseif: { cond: 'data.x == 1', content: '', children: [nestedIf] },
        });
        const mainIf = new IfNode({
          if: { cond: 'data.x == 0', content: '', children: [elseIf] },
        });
    ...
    describe('Complex Conditional Chains', () => {
      it('should handle multiple elseif conditions with various data types', async () => {
        ...
        const elseIf2 = new ElseIfNode({
          elseif: {
            cond: 'data.numberVar == 42',
            content: '',
            children: [elseIf2Assign],
          },
        });

        const elseIf3Assign = new AssignNode({
          assign: {
            location: 'data.result',
            expr: '"bool true"',
            content: '',
        ...
        const elseIf3 = new ElseIfNode({
          elseif: {
            cond: 'data.boolVar == true',
            content: '',
            children: [elseIf3Assign],
          },
        });
        ...
        const ifNode = new IfNode({
          if: {
            cond: 'data.stringVar == "nottest"',
            content: '',
            children: [ifAssign, elseIf1, elseIf2, elseIf3, elseNode],
          },
        });
    ...
    describe('Error Handling', () => {
      it('should handle errors in elseif conditions', async () => {
        ...
        const elseIfAssign = new AssignNode({
          assign: {
            location: 'data.result',
            expr: '"should not execute"',
            content: '',
        ...
        const elseIf = new ElseIfNode({
          elseif: {
            cond: 'undefinedVar.property',
            content: '',
            children: [elseIfAssign],
          },
        });
        const elseAssign = new AssignNode({
          assign: {
    ...
    describe('State Immutability', () => {
      it('should not modify original state when no conditions match', async () => {
        ...
        const ifNode = new IfNode({
          if: { cond: 'data.x == 0', content: '', children: [assignNode] },
        });
